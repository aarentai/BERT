...
def compute_metrics(true_named_entities, pred_named_entities, tags):
    ...
    eval_metrics = {'correct': 0, 'incorrect': 0, 'partial': 0, 'missed': 0, 'spurious': 0, 'precision': 0, 'recall': 0,'f1_score': 0,}
...
#                     evaluation_agg_entities_type[true]['exact']['spurious'] += 1
                ...
                evaluation['strict']['incorrect'] += 1
                evaluation['ent_type']['incorrect'] += 1
                evaluation['partial']['incorrect'] += 1
                evaluation['exact']['incorrect'] += 1
                evaluation_agg_entities_type[pred.e_type]['strict']['incorrect'] += 1
                evaluation_agg_entities_type[pred.e_type]['ent_type']['incorrect'] += 1
                evaluation_agg_entities_type[pred.e_type]['partial']['incorrect'] += 1
                evaluation_agg_entities_type[pred.e_type]['exact']['incorrect'] += 1
